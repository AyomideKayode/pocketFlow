...
const badges = [
  {
    icon: ShieldCheck,
    title: "Firebase Auth",
    description: "Industry-leading authentication. Your credentials never touch our servers."
  },
  {
    icon: Lock,
    title: "Your data stays yours",
    description: "We never sell your data. No third-party tracking. No ads. Ever."
  },
  {
    icon: Building2,
    title: "No bank login required",
    description: "Manual tracking means you're in control. We never need access to your accounts."
  }
];
