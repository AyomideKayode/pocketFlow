import type { EmailProvider, EmailMessage, EmailResult, EmailCategory } from '../lib/email/types.js';
...
export class EmailService {
  ...
  private async checkPreferences(userId: string, category: EmailCategory): Promise<boolean> {
      try {
